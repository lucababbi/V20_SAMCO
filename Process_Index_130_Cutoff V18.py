...
InfoCode = pd.read_csv(r"C:\Users\lbabbi\OneDrive - Qontigo\Desktop\GitHub\stoxx-world-msci\Size Labelling\InfoCode.csv", parse_dates=["vf", "vt"])
...
Dates_Frame = pd.read_csv(r"C:\Users\lbabbi\OneDrive - Qontigo\Desktop\GitHub\stoxx-world-msci\V18\Dates\Review_Date-MAR-SEP.csv", index_col=0, parse_dates=["Review", "Cutoff"])
Dates_Frame_JUNDEC = pd.read_csv(r"C:\Users\lbabbi\OneDrive - Qontigo\Desktop\GitHub\stoxx-world-msci\V18\Dates\Review_Date-JUN-DEC.csv", index_col=0, parse_dates=["Review", "Cutoff"])
...
Input = pd.read_csv(r"C:\Users\lbabbi\OneDrive - Qontigo\Desktop\GitHub\stoxx-world-msci\V18\Universe\SWESCGV_MARSEP.csv",
                    index_col=0, parse_dates=["Date", "Cutoff"])
    
Input_JUNDEC = pd.read_csv(r"C:\Users\lbabbi\OneDrive - Qontigo\Desktop\GitHub\stoxx-world-msci\V18\Universe\SWESCGV_JUNDEC.csv",
...
Securities_Cutoff_MARSEP = pd.read_csv(r"C:\Users\lbabbi\OneDrive - Qontigo\Desktop\GitHub\stoxx-world-msci\V18\Security_Cutoff\Output_Securities_Cutoff_MARSEP.csv",
...
Securities_Cutoff_JUNDEC = pd.read_csv(r"C:\Users\lbabbi\OneDrive - Qontigo\Desktop\GitHub\stoxx-world-msci\V18\Security_Cutoff\Output_Securities_Cutoff_JUNDEC.csv",
                                       sep=",", parse_dates=["validDate"], index_col=0).rename(columns={"stoxxId": "stoxxId_Cutoff", "currency": "currency_Cutoff",
                                                                                                        "closePrice": "closePrice_Cutoff", "freeFloat": "freeFloat_Cutoff",
                                                                                                        "shares": "shares_Cutoff", "Capfactor": "Capfactor_Cutoff"})
...
Turnover = pd.read_csv(r"C:\Users\lbabbi\OneDrive - Qontigo\Desktop\GitHub\stoxx-world-msci\V18\Turnover\Output_Turnover_Cutoff_3M_MARSEP.csv", 
                    parse_dates=["Date"], dtype={"InfoCode": "int64"})
Turnover_JUNDEC = pd.read_csv(r"C:\Users\lbabbi\OneDrive - Qontigo\Desktop\GitHub\stoxx-world-msci\V18\Turnover\Output_Turnover_Cutoff_3M_JUNDEC.csv",
                    parse_dates=["Date"], dtype={"InfoCode": "int64"})
...
# Version
Version = "18_Cutoff_Mcap_Enhanced"   
...
FX_Rate = pd.read_csv(r"C:\Users\lbabbi\OneDrive - Qontigo\Desktop\GitHub\stoxx-world-msci\V18\FX\FX_Historical.csv", index_col=0, parse_dates=["cutoff_date"])
...
Output.to_csv(r"C:\Users\lbabbi\OneDrive - Qontigo\Desktop\GitHub\stoxx-world-msci\MSCI EM Small Cap\Output\Candidates\Final_Buffer_V" + str(Version) + ".csv")