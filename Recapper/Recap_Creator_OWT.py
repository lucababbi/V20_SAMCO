...
SPDR = pd.read_csv(r"C:\Users\lbabbi\OneDrive - ISS\Desktop\Projects\SAMCO\V20_SAMCO\Output\Client_Shared\SPDR_DEC-2023.csv", sep=";")
...
for Version in Versions:
    ...
    current_df["Weight_V4"] = 0
    current_df["Weight_V5"] = 0
    ...
    if Version != "V4":
        current_df["Weight_V4"] = current_df["Internal_Number"].map(Frame["V4"].set_index("Internal_Number")["Weight"].to_dict()).fillna(0)
    if Version != "V5":
        current_df["Weight_V5"] = current_df["Internal_Number"].map(Frame["V5"].set_index("Internal_Number")["Weight"].to_dict()).fillna(0)
    ...
    Final_Frame[Version] = pd.DataFrame({
        ...
        "Weight_V4": current_df["Weight_V4"],
        "Weight_V5": current_df["Weight_V5"],
        ...
        "InV4": current_df["Internal_Number"].isin(Frame["V4"]["Internal_Number"]),
        "InV5": current_df["Internal_Number"].isin(Frame["V5"]["Internal_Number"]),
